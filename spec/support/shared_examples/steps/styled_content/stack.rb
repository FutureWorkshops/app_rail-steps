...
shared_examples_for "styled_content_stack" do |_param|
  describe "#ar_styled_content_stack_title" do
    let(:result) { subject.ar_styled_content_stack_title(title: "Challenges") }
  ...
  describe "#ar_styled_content_stack_text" do
    let(:result) { subject.ar_styled_content_stack_text(text: "These are the challenges") }
  ...
  describe "#ar_styled_content_stack_list_item" do
    context "url" do
      let(:result) do
        subject.ar_styled_content_stack_list_item(text: "John Doe", detail_text: "Participant",
  ...
  describe "#ar_styled_content_stack_button" do
    context "url" do
      let(:result) { subject.ar_styled_content_stack_button(label: "Leave Challenge", url: "https://test.com/leave", method: :put, on_success: :backward, style: :danger, confirm_title: "Confirm", confirm_text: "Are you sure?") }
    ...
    context "link url" do
      let(:result) { subject.ar_styled_content_stack_button(label: "Copy & Share Link", link_url: "https://test.com/share", on_success: :none, style: :textOnly) }
    ...
    context "system links" do
      let(:result) do
        subject.ar_styled_content_stack_button(label: "Donate", apple_system_url: "https://test.com/donate",
    ...
    context "link id" do
      let(:result) do
        subject.ar_styled_content_stack_button(label: "Import", link_id: "9e5ad548-dd58-4f9b-adbe-99c59049398", on_success: :reload,
                                               style: :outline)
      end
    ...
    context "modal workflow" do
      let(:result) do
        subject.ar_styled_content_stack_button(label: "Import", modal_workflow_name: "Import Activity", on_success: :reload,
                                               style: :outline)
      end
    ...
    context "share text and share image url" do
      let(:result) do
        subject.ar_styled_content_stack_button(label: "Share Challenge", share_text: "Challenge completed!",

...
shared_examples_for "core_forms_form" do
  ...
  describe "#ar_core_forms_form_multiple_selection" do
    ...
    let(:result) do
      subject.ar_core_forms_form_multiple_selection(label: "Challenge Type", id: 1,
  ...
  describe "#ar_core_forms_form_multiple_selection_options" do
    let(:result) do
      subject.ar_core_forms_form_multiple_selection_options(text: "Open for all", hint: "Every user will be able to join",
  ...
  describe "#ar_core_forms_form_number" do
    let(:result) do
      subject.ar_core_forms_form_number(label: "Target Amount", id: 1, placeholder: "100 Eur", default_text_answer: 50)
    end
  ...
  describe "#ar_core_forms_form_text" do
    let(:result) do
      subject.ar_core_forms_form_text(label: "Your Location", id: 1, placeholder: "London",
  ...
  describe "#ar_core_forms_form_date" do
    let(:result) { subject.ar_core_forms_form_date(label: "Start Date", id: 1, optional: true) }
  ...
  describe "#ar_core_forms_form_email" do
    let(:result) do
      subject.ar_core_forms_form_email(label: "Your Email", id: 1, placeholder: "example@email.com",
  ...
  describe "#ar_core_forms_form_password" do
    let(:result) do
      subject.ar_core_forms_form_password(label: "Your Password", id: 1, placeholder: "Secret123",
